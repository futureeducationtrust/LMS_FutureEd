  ...
  useEffect(() => {
    ...
    setForm({
      ...
      dateOfBirth: lead.dateOfBirth
        ? String(lead.dateOfBirth).split("T")[0]!
        : "",
      fatherName: lead.fatherName ?? "",
      gender: lead.gender ?? "",
      maritalStatus: lead.maritalStatus ?? "",
      courseIds:
        lead.courses?.map((c: { course: { id: string } }) => c.course.id) ?? [],
      ...
      nextFollowUpAt: lead.nextFollowUpAt
        ? new Date(lead.nextFollowUpAt as unknown as string)
            .toISOString()
            .slice(0, 16)
        : "",
    });
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          if (e.target.checked)
                            ...
                            set(
                              "courseIds",
                              form.courseIds.filter((cid) => cid !== course.id),
                            );
                        }}
